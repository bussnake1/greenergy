...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const response = await fetch(`${config.apiBaseUrl}/unavailability/export/excel${queryString}`, {
      headers: {
    ...
    setResponseHeader(event, 'Content-Disposition', 'attachment; filename=unavailabilities.xlsx');
